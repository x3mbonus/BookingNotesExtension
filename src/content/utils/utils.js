...
async function getNote(propertyId) {
    ...
    if (data) {
        return {
            ...
            price_airbnb: data.price_airbnb || '',
            ...
            toilets_count: data.toilets_count || '',
            toilet_inside: data.toilet_inside || '',
...
async function saveNote(propertyId, noteData) {
    const result = await window.SupabaseApi.savePropertyData(propertyId,
        ...
        {
            name: noteData.name,
            price_booking: noteData.price_booking,
            price_airbnb: noteData.price_airbnb,
            location: noteData.location,
            site_rating: noteData.site_rating,
            property_type: noteData.property_type,
            bedrooms_count: noteData.bedrooms_count,
            sleeping_places: noteData.sleeping_places,
            bathrooms_count: noteData.bathrooms_count,
            toilets_count: noteData.toilets_count,
            toilet_inside: noteData.toilet_inside,
            heating_type: noteData.heating_type,
            last_review_date: noteData.last_review_date,
            cancellation_policy: noteData.cancellation_policy,
            url: noteData.url
        }
    );
