        ...
        try {
            ...
            if (Array.isArray(data) && data.length > 0) {
                ...
                return {
                    ...
                    name: row.name || null,
                    price_booking: row.price_booking || null,
                    price_airbnb: row.price_airbnb || null,
                    location: row.location || null,
                    site_rating: row.site_rating || null,
                    platform: row.platform || null,
                    property_type: row.property_type || null,
                    bedrooms_count: row.bedrooms_count || null,
                    sleeping_places: row.sleeping_places || null,
                    bathrooms_count: row.bathrooms_count || null,
                    toilets_count: row.toilets_count || null,
                    toilet_inside: row.toilet_inside || null,
    ...
    async savePropertyData(propertyId, noteData, featuresData, metadata = {}) {
        ...
        try {
            ...
            const updatePayload = {
                ...
                ...(metadata.price_booking        && { price_booking: metadata.price_booking }),
                ...(metadata.price_airbnb         && { price_airbnb: metadata.price_airbnb }),
                ...(metadata.location             && { location: metadata.location }),
                ...(metadata.site_rating          && { site_rating: metadata.site_rating }),
                ...(metadata.platform             && { platform: metadata.platform }),
                ...(metadata.property_type        && { property_type: metadata.property_type }),
                ...(metadata.bedrooms_count       && { bedrooms_count: metadata.bedrooms_count }),
                ...(metadata.sleeping_places      && { sleeping_places: metadata.sleeping_places }),
                ...(metadata.bathrooms_count      && { bathrooms_count: metadata.bathrooms_count }),
                ...(metadata.toilets_count        && { toilets_count: metadata.toilets_count }),
                ...(metadata.toilet_inside        && { toilet_inside: metadata.toilet_inside }),
                ...(metadata.heating_type         && { heating_type: metadata.heating_type }),
                ...(metadata.last_review_date     && { last_review_date: metadata.last_review_date }),
            ...
            const insertPayload = {
                ...
                price_booking: metadata.price_booking || null,
                price_airbnb: metadata.price_airbnb || null,
                location: metadata.location || null,
                site_rating: metadata.site_rating || null,
                platform: metadata.platform || null,
                property_type: metadata.property_type || null,
                bedrooms_count: metadata.bedrooms_count || null,
                sleeping_places: metadata.sleeping_places || null,
                bathrooms_count: metadata.bathrooms_count || null,
                toilets_count: metadata.toilets_count || null,
                toilet_inside: metadata.toilet_inside || null,
                heating_type: metadata.heating_type || null,
                last_review_date: metadata.last_review_date || null,
